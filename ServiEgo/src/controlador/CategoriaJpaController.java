...
public class CategoriaJpaController implements Serializable {
    ...
    public List<String> distincxcategoria() {
        
        Query query = getEntityManager().createQuery("SELECT DISTINCT c.nombreCategoria from Categoria c");
        return query.getResultList();//getSingleResult
        
    }
    
    public Categoria consultarxNombre(String nombreCategoria) {
        try {
            Query query = getEntityManager().createQuery("select c from Categoria c where c.nombreCategoria = :nombreCategoria")
