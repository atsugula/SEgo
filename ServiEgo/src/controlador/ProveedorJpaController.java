...
public class ProveedorJpaController implements Serializable {
    ...
    //Se utiliza para que no se permita eliminar un producto o proveedor que esten relacionados
    public List<Producto> preguntarProductos(Producto codigo){
        Query query = getEntityManager().createQuery("SELECT p FROM Proveedor p WHERE p.productoList = :codigo")
